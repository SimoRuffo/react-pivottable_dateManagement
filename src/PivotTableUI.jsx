...
var DraggableAttribute = exports.DraggableAttribute = function (_React$Component) {
  ...
  function DraggableAttribute(props) {
    ...
    _this.state = { open: false, filterText: '',filterTextFrom:'',filterTextTo:'' };
    return _this;
  }
  ...
  _createClass(DraggableAttribute, [{
    ...
    key:'matchesFilterFromTo',
    value: function matchesFilterFromTo(x) {
...
//# sourceMappingURL=PivotTableUI.js.map3
